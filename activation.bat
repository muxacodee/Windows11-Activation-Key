...
cscript //nologo c:\windows\system32\slmgr.vbs /ato | find /i "successfully" && (echo.& echo ====================================== & echo. & choice /n /c YN /m "Kanalimga obuna bo'lishni istaysizmi? [Y,N]?" & if errorlevel 2 exit) || (echo Serverga ulanishda xatolik! Boshqa serverga ulanmoqda... & echo Biroz kuting... & echo. & echo. & set /a i+=1 & goto server)

explorer "http://youtube.com/@muxacode"&goto halt

:notsupported

echo ======================================&echo.&echo Kechirasiz! Sizning versiyangiz qollab-quvvatlanmaydi.
